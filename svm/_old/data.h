#ifndef SVM_DATA_DATA_H
#define SVM_DATA_DATA_H
#include "osqp.h"
...
/* function prototypes */
OSQPTestData * generate_problem_svm_data();
void clean_problem_svm_data(OSQPTestData * data);
svm_data_sols_data *  generate_problem_svm_data_sols_data();
void clean_problem_svm_data_sols_data(svm_data_sols_data * data);
...
svm_data_sols_data * data = (svm_data_sols_data *)c_malloc(sizeof(svm_data_sols_data));
