...
def construct_svm_OSQP(P, q, A, l, u, problem_name):
    """
    ...
    f.write("OSQPData * generate_problem();\n")
    f.write("void clean_problem(OSQPData * data);\n")
    ...
    f.write("OSQPData * data = (OSQPData *)malloc(sizeof(OSQPData));\n\n")
