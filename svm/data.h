#ifndef N10M10_1_DATA_H
#define N10M10_1_DATA_H
#include "osqp.h"


/* function prototypes */
OSQPData * generate_problem();
void clean_problem(OSQPData * data);
...
// Problem vectors
data->l = (float*) malloc(20 * sizeof(float));
data->l[0] = -OSQPINFTY;
data->l[1] = -OSQPINFTY;
data->l[2] = -OSQPINFTY;
data->l[3] = -OSQPINFTY;
...
data->u = (float*) malloc(20 * sizeof(float));
...
data->u[18] = OSQPINFTY;
data->u[19] = OSQPINFTY;
data->q = (float*) malloc(20 * sizeof(float));
