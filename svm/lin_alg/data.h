...
c_float test_vec_ops_sc1;
csc * test_mat_extr_triu_Pu;
csc * test_sp_matrix_A;
c_float test_vec_ops_sc2;
...
data->test_mat_vec_Px[0] = -0.29566523262731403410;
data->test_mat_vec_Px[1] = 0.15419581312127433881;
data->test_mat_vec_Px[2] = 0.04266432782051569200;
data->test_mat_vec_Px[3] = -0.38827368634740055953;
data->test_mat_vec_Px_cum = (c_float*) c_malloc(4 * sizeof(c_float));
data->test_mat_vec_Px_cum[0] = 0.48353115739819907404;
data->test_mat_vec_Px_cum[1] = -0.05341187779748918230;
data->test_mat_vec_Px_cum[2] = -0.43227160308871065419;
data->test_mat_vec_Px_cum[3] = -0.43881137961326488472;
data->test_vec_ops_norm_inf = 2.04032304872871517176;
data->test_vec_ops_add_scaled = (c_float*) c_malloc(10 * sizeof(c_float));
data->test_vec_ops_add_scaled[0] = -0.91591277775921642323;
data->test_vec_ops_add_scaled[1] = -2.78712432775341900637;
data->test_vec_ops_add_scaled[2] = 1.03688745833707240962;
data->test_vec_ops_add_scaled[3] = -1.80509107676382551944;
data->test_vec_ops_add_scaled[4] = 0.74829495307626692213;
data->test_vec_ops_add_scaled[5] = 0.09140820207639510642;
data->test_vec_ops_add_scaled[6] = 0.81598033983789042267;
data->test_vec_ops_add_scaled[7] = -3.18984830096740434868;
data->test_vec_ops_add_scaled[8] = 4.93683592099753454363;
data->test_vec_ops_add_scaled[9] = -0.81461643855245347012;
data->test_mat_extr_triu_n = 5;
data->test_mat_vec_Ax_cum = (c_float*) c_malloc(5 * sizeof(c_float));
data->test_mat_vec_Ax_cum[0] = 2.31380632790673335109;
data->test_mat_vec_Ax_cum[1] = -1.30729683396110774041;
data->test_mat_vec_Ax_cum[2] = -0.29336379025495928907;
data->test_mat_vec_Ax_cum[3] = 0.27154004670215803330;
data->test_mat_vec_Ax_cum[4] = 1.28496892006843643763;
...
data->test_qpform_Pu->x = (c_float*) c_malloc(9 * sizeof(c_float));
...
data->test_qpform_Pu->i = (c_int*) c_malloc(9 * sizeof(c_int));
...
data->test_mat_ops_prem_diag->x[0] = -0.04787250769610111589;
data->test_mat_ops_prem_diag->x[1] = 0.19803946274895048441;
data->test_mat_ops_prem_diag->x[2] = -0.84571734393041497757;
...
data->test_qpform_x[0] = -0.33105850665473329775;
data->test_qpform_x[1] = 0.35913333179380452220;
data->test_qpform_x[2] = 0.62222041446793285857;
data->test_qpform_x[3] = 0.96078194484322809732;
...
data->test_mat_vec_ATy_cum[0] = 2.09825612327069199736;
data->test_mat_vec_ATy_cum[1] = 0.26995863321741420116;
data->test_mat_vec_ATy_cum[2] = -0.35503101351136706620;
data->test_mat_vec_ATy_cum[3] = 1.64781363039076311772;
...
data->test_mat_ops_postm_diag->x[0] = -0.04787250769610111589;
data->test_mat_ops_postm_diag->x[1] = -0.35878691390952061058;
data->test_mat_ops_postm_diag->x[2] = 0.46681024846877633427;
...
data->test_mat_vec_x[0] = 0.77919639002551310814;
data->test_mat_vec_x[1] = -0.20760769091876352110;
data->test_mat_vec_x[2] = -0.47493593090922636701;
data->test_mat_vec_x[3] = -0.05053769326586431826;
data->test_mat_vec_y = (c_float*) c_malloc(5 * sizeof(c_float));
data->test_mat_vec_y[0] = 1.96231586074821984234;
data->test_mat_vec_y[1] = -1.49139808547822494411;
data->test_mat_vec_y[2] = -0.02272573072923615017;
data->test_mat_vec_y[3] = 0.17340019433320591480;
data->test_mat_vec_y[4] = 0.89790379043719648067;
...
data->test_mat_extr_triu_P_inf_norm_cols[4] = 1.24013092374282529740;
...
data->test_mat_vec_ATy[0] = 1.31905973324517877820;
data->test_mat_vec_ATy[1] = 0.47756632413617772226;
data->test_mat_vec_ATy[2] = 0.11990491739785930081;
data->test_mat_vec_ATy[3] = 1.69835132365662744292;
data->test_qpform_value = 0.43788049589018218644;
data->test_vec_ops_sc1 = 0.69511960504699144003;
...
data->test_mat_extr_triu_Pu->x[1] = 0.03180487603576731548;
...
data->test_mat_extr_triu_Pu->x[5] = 1.07939560863581207606;
data->test_mat_extr_triu_Pu->x[6] = 0.35417242096340495472;
data->test_mat_extr_triu_Pu->x[7] = 1.12964779320375763305;
data->test_mat_extr_triu_Pu->x[8] = 1.38118030249938827936;
data->test_mat_extr_triu_Pu->x[9] = 0.95107793820572439358;
data->test_mat_extr_triu_Pu->x[10] = 0.34609815153014733546;
data->test_mat_extr_triu_Pu->x[11] = 0.83747221011704786608;
data->test_mat_extr_triu_Pu->x[12] = 1.24013092374282529740;
data->test_mat_extr_triu_Pu->x[13] = 1.06615741735591762485;
...
data->test_vec_ops_sc2 = -2.03346654612261357187;
...
data->test_mat_vec_Ax[0] = 0.35149046715851334222;
data->test_mat_vec_Ax[1] = 0.18410125151711714819;
data->test_mat_vec_Ax[2] = -0.27063805952572311808;
data->test_mat_vec_Ax[3] = 0.09813985236895211850;
data->test_mat_vec_Ax[4] = 0.38706512963123995696;
...
data->test_mat_ops_d[0] = -1.14533805578424119354;
data->test_mat_ops_d[1] = 0.63219176742504867850;
...
data->test_mat_extr_triu_P->x[1] = 0.03180487603576731548;
...
data->test_mat_extr_triu_P->x[5] = 0.03180487603576731548;
...
data->test_mat_extr_triu_P->x[12] = 1.07939560863581207606;
data->test_mat_extr_triu_P->x[13] = 1.38118030249938827936;
data->test_mat_extr_triu_P->x[14] = 1.24013092374282529740;
data->test_mat_extr_triu_P->x[15] = 0.35417242096340495472;
data->test_mat_extr_triu_P->x[16] = 1.12964779320375763305;
data->test_mat_extr_triu_P->x[17] = 1.38118030249938827936;
data->test_mat_extr_triu_P->x[18] = 0.95107793820572439358;
data->test_mat_extr_triu_P->x[19] = 1.06615741735591762485;
data->test_mat_extr_triu_P->x[20] = 0.34609815153014733546;
data->test_mat_extr_triu_P->x[21] = 0.83747221011704786608;
data->test_mat_extr_triu_P->x[22] = 1.24013092374282529740;
data->test_mat_extr_triu_P->x[23] = 1.06615741735591762485;
