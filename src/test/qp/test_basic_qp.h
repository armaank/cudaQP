...
//   params->verbose       = 1;
//   params->warm_start    = 0;
//   params->linsys_solver = MKL_PARDISO_SOLVER;

//   // Setup workspace
//   exitflag = qp_setup(&work, data, params);

//   // Setup correct
//   ut_assert("Basic QP test solve Pardiso: Setup error!", exitflag == 0);

//   // Solve Problem
//   qp_solve(work);

//   // Compare solver statuses
//   ut_assert("Basic QP test solve Pardiso: Error in solver status!",
//             work->info->status_val == sols_data->status_test);

//   // Compare primal solutions
//   ut_assert("Basic QP test solve Pardiso: Error in primal solution!",
//             vec_norm_inf_diff(work->solution->x, sols_data->x_test,
//                               data->n) < TESTS_TOL);

//   // Compare dual solutions
//   ut_assert("Basic QP test solve Pardiso: Error in dual solution!",
//             vec_norm_inf_diff(work->solution->y, sols_data->y_test,
//                               data->m) < TESTS_TOL);


//   // Compare objective values
//   ut_assert("Basic QP test solve Pardiso: Error in objective value!",
//             c_absval(work->info->obj_val - sols_data->obj_value_test) <
//             TESTS_TOL);
